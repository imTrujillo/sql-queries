...
class TestController extends Controller
{
    ...
    public function Ex4()
    {
        //Se filtra la tabla de pedidos, con el total oscilando entre valores de 100-250.
        return Pedido::select('*')->whereBetween('total', [100, 250])->get();
    }
    public function Ex5()
    {
        //Se filtra la tabla de usuarios, sólo se muestran nombres con letra inicial R.
    ...
    public function Ex9()
    {
        //Se filtra la base de datos, obteniendo el pedido mas económico junto a su nombre de usuario.
    ...
    {
        //Se clasifican los pedidos (nombre, cantidad, total) según el nombre de usuario. 
